...
AS $$
DECLARE
  project_url TEXT := 'https://jkqxzvjefmgrubmdbyea.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImprcXh6dmplZm1ncnVibWRieWVhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDEzMDQ5MywiZXhwIjoyMDI1NzA2NDkzfQ.JZgLYG4icD3eA97p78THxw_-IjkzGInz4ZvEDQqY_Mo'; -- full access needed for http request to storage
